...
exports.config = {
	...
	*/
	...
	'BASE_DRONE_HP': 2000,
	// scale-consistent with a tank's own body damage: 13.852814 * 7/20 (entities/Player.js's OLD
	// this.damage base, PENDING #17 - un-baked to 3.4632035 = 13.852814/4 by plan.md step 5's
	// damage-multiplier-table rewrite, which does not change this derivation) - the wiki's own
	// 7-vs-20 bullet:body-damage ratio, applied in reverse to get a drone dealing bullet-like damage
	// rather than a full body ram. Lands on exactly 4.84848, Basic's own can.damage (TanksConfig.js)
	// - not a coincidence, since that ratio is where 13.852814 itself came from.
	...
	*/
	...
	'BASE_DRONE_DETECT': gu(18),        // enemy detection range - diep's ai.viewRange 900 du = 504
	// units = gu(18) (diepcustom/src/Entity/Tank/Projectile/Drone.ts:38), measured from the BASE
	// like this constant already was, not the drone (plan.md Step 10). Was gu(60) = 3.3x diep's.
