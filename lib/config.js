...
exports.config = {
	...
	*/
	...
	'BASE_DRONE_CHASE_SPEED': 16.0,      // per ref tick -> 400 u/s, and also the return-to-ring
	...
	// motion()/shoot() recurrence over every reachable class (Fighter L29 riding its rear pair,
	// 399.2 u/s). The user's spec is EXACTLY that ceiling: not faster, so lapping a base in the
	...
	// Derived by holding the turn radius (v/omega) at ~60 units, one tank diameter, at the 400 u/s
	// dash: 400/60 = 6.67. It rides the same smoothstep k as the return's speed blend, which is
