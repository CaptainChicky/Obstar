...
const CONFIG = {
		...
		'BOT_PATHS': [
			...
			{ class: ['Machine Gun', 'Gunner', 'Gunner Trapper'] },
			{ class: ['Machine Gun', 'Gunner', 'Streamliner'] },
			// Sprayer is tier-2 off Machine Gun only; path[1] is held until 45
			{ class: ['Machine Gun', 'Sprayer', 'Sprayer'] },
			{ class: ['Flank Guard', 'Triangle', 'Booster'] },
			{ class: ['Flank Guard', 'Triangle', 'Fighter'] },
			{ class: ['Sniper', 'Overseer', 'Overlord'] },
			{ class: ['Sniper', 'Overseer', 'Overtrapper'] },
			{ class: ['Machine Gun', 'Destroyer', 'Hybrid'] },
			{ class: ['Machine Gun', 'Destroyer', 'Annihilator'] },
			{ class: ['Smasher', 'Spike', 'Spike'], up: 2 },
			{ class: ['Smasher', 'Landmine', 'Landmine'], up: 2 },
		],
		/*
		...
		*/
		'BOT_UPS': [
			...
			[1, 1, 3, 3, 4, 4, 2, 2, 2,
				...
				1, 1, 3, 3, 4, 0, 0, 0, 4,
				2, 2, 1, 3, 0, 0],
			// SMASHER / body damage (0=MSpeed, 5=BodyDam, 6=HpUp, 7=HpRegan)
			[7, 6, 7, 6, 7, 6, 7,
				5, 5, 5, 5, 5, 5, 5,
				0, 0, 0, 0, 0, 0, 0,
				6, 6, 6, 6, 7, 7, 7,
