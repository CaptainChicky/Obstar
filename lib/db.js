/*
	The one Postgres connection point for the whole server. Centralized so pool sizing / TLS /
	read-replica routing land in one place. Off unless config.DB.ON (default false) - see
	lib/config.js.
*/
