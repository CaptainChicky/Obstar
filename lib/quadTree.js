/*
	...
	insert() and queryCircle() (plan.md WP4.5.4) were rewritten together, in the same commit,
...
class quadTree {
	...
	insert(x, y, size, data) {
		...
		// Guarded on this.w > 64 (plan.md WP4.5.4): without it, a spawn bug piling many entities
	...
	/*
		Allocation-free circle query (plan.md WP4.5.4), for rooms/Room.js's collision pass -
