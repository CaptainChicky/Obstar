/*
	The one place the grid pitch is written down (massplanchunks WP1 - see plan.md).
	...
	1 grid square = 1 diep grid unit (gu) = 28 world units - derived in plan.md from the user's
	measurements against real diep.io (a level-0 tank is 2 gu across, and 28 units/gu is also what
	the existing recoil table already assumes - PENDING #13).
